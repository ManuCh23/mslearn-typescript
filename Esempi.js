...
var x; //espllicitamente dichiaro x di tipo numero
var y = 1; //implicitamente dichiaro y di tipo numero
var z; //dichiaro z senza inizializzarla
...
var employeeStatus = ContractStatus.Temp; //stampa 1 perche enum partono da 0(zero)
...
if (typeof rValue === "string") {
    console.log(rValue.toUpperCase()); //senza asserzione di tipo non si poteva accedere al metodo toUpperCase()
}
else {
...
var myInp = document.getElementById("myInput"); //con l'asserzione di tipo dico al compilatore che so in anticipo il tipo del dato ritornato
